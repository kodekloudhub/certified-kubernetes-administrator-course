...
* Clone this repo down to your Mac. Open your Mac's terminal application. All commands in this guide are executed from the terminal.
    ...
    cd certified-kubernetes-administrator-course/apple-silicon/scripts
    ```
...
Because we cannot use VirtualBox and are instead using Multipass, [a script is provided](./scripts/deploy-virtual-machines.sh) to create the three VMs.
