...
Perform all the following steps on each of  `controlplane01`, `controlplane02`, `controlplane03`, `node01` and `node02`.
...
Next: [Control Plane setup](./06-controlplane.md)</br>
Prev: [Load Balancer Setup](./04-loadbalancer.md)
