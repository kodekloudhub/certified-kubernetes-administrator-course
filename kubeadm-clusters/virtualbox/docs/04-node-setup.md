...
1.  Prepare extra arguments for kubelet such that when it starts, it listens on the VM network address and not the NAT one. This uses the predefined `IP_ADDRESS` environment variable. Paste the following to the terminal
